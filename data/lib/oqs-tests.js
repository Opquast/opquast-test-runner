...
var regFunction = new RegExp("([^\\s:{}&|]*)\\(", "i"),
    ...
    regAnalytics = new RegExp("((^https?://[^/]+\\.((google-analytics|xiti|cybermonitor|estat|smartadserver|tradedoubler|sharethis|twitter|facebook)\\.com/|(weborama)\\.fr|(contentspread|doubleclick|ad4mat)\\.net))|/piwik\\.php\\?)", "i"),
